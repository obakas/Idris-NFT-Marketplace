...
contract IdrisNftMarketplaceTest is Test {
    IdrisNftMarketplace marketplace;
    MockERC721 nft;
    ...
    function setUp() public {
        ...
        marketplace = new IdrisNftMarketplace(address(paymentToken));
    ...
    function test_ListItem() public {
        ...
        IdrisNftMarketplace.Listing memory listing = marketplace.getListing(address(nft), NFT_ID);
    ...
    function test_RevertWhen_ListItemPriceZero() public {
        ...
        vm.expectRevert(IdrisNftMarketplace.PriceMustBeAboveZero.selector);
    ...
    function test_RevertWhen_ListItemNotOwner() public {
        ...
        vm.expectRevert(IdrisNftMarketplace.NotOwner.selector);
        marketplace.listItem(address(nft), NFT_ID, PRICE);
    ...
    function test_RevertWhen_ListItemNotApproved() public {
        ...
        vm.expectRevert(IdrisNftMarketplace.NotApprovedForMarketplace.selector);
        marketplace.listItem(address(nft), NFT_ID, PRICE);
    ...
    function test_RevertWhen_ListItemAlreadyListed() public {
        ...
        // Try to list again
        vm.startPrank(seller);
        vm.expectRevert(abi.encodeWithSelector(IdrisNftMarketplace.AlreadyListed.selector, address(nft), NFT_ID));
        marketplace.listItem(address(nft), NFT_ID, PRICE);
        vm.stopPrank();
    }
    ...
    function test_RevertWhen_CancelListingNotListed() public {
        vm.startPrank(seller);
        vm.expectRevert(abi.encodeWithSelector(IdrisNftMarketplace.NotListed.selector, address(nft), NFT_ID));
        marketplace.cancelListing(address(nft), NFT_ID);
        vm.stopPrank();
    }
    ...
    function test_RevertWhen_WithdrawProceedsNoProceeds() public {
        vm.startPrank(seller);
        vm.expectRevert(IdrisNftMarketplace.NoProceeds.selector);
        marketplace.withdrawProceeds();
        vm.stopPrank();
    }
